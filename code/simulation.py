...
class OptimModel():
    ...
    - settings: Dictionary containing settings that will be passed to the solver
    ...
    """
    def __init__(self, solver: str,activities: List[ActivityData], utility_parameters: Dict,  settings: Dict = {'optimality_target': 3, 'time_limit': 120}, *args, **kwargs) -> None:
        """
        Parameters:
        ---------------
        - solver: String, 'MIP' or 'CP'
...
class MIP(OptimModel):
    ...
    def initialize(self) -> None:
        ...
        self.model = Model()
        self.model.parameters.optimalitytarget = self.settings['optimality_target']
        self.model.parameters.timelimit = self.settings['time_limit']
